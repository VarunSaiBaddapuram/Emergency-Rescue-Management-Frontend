...
import FloodPredict from "./scenes/js/App"; // This will be migrated to FloodPredict.tsx
...
const Home: React.FC = () => {
  ...
  const mapComponentsRef = useRef<any>(null);

  const handleSOS = () => {
    setIsSOSClicked(true);
    if (mapComponentsRef.current && typeof mapComponentsRef.current.handleSOSClick === "function") {
